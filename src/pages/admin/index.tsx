...
const Admin = () => {
  ...
  return (
    <main className="relative bg-sky-900 h-screen text-white overflow-auto">
      <Header />
      <div className="pt-16" />
      {/* Header space */}
...
const IssueCard: FC<Issue & any> = ({
  ...
  return (
    <div className="text-white mx-auto shadow-lg rounded-lg w-[300px] p-4 bg-sky-800 flex flex-col items-start">
